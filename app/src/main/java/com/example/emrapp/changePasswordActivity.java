...
public class changePasswordActivity extends AppCompatActivity {
    ...
    private void changePassword() {
        ...
        HOST = "http://18.216.245.34/EMRapp/Patients/changePswd.php?id="+id+"&password="+NewPswd;
        ...
        else
        {
            ...
            Toast.makeText(changePasswordActivity.this,"Two Passwords are not Matching...",Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void sendNewPassword() {
        StringRequest stringRequest=new StringRequest(Request.Method.POST, HOST,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try
                        {
                            ...
                            {
                                progressDialog.dismiss();
                                Toast.makeText(changePasswordActivity.this,"Change Password Succusfully!!",Toast.LENGTH_LONG).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                            progressDialog.dismiss();
                            Toast.makeText(changePasswordActivity.this, "Error Occured due to "+ e.toString(), Toast.LENGTH_SHORT).show();
                        }
            ...
            {
                progressDialog.dismiss();
                Toast.makeText(changePasswordActivity.this, "Error Occured "+ error.toString(), Toast.LENGTH_SHORT).show();
